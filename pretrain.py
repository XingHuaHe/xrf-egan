...
def training(args: argparse.ArgumentParser) -> None:
    """
    ...
    if os.path.basename(args.noisy_set).endswith('.mat'):
        ...
        print("Finished the loading of the dataset.")
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--G_pretrained_weight', type=str, default=None, help='Path to ckpt file to pre-load in training (Def: None).')
    ...
    parser.add_argument('--intervel', type=int, default=200, help="")
    parser.add_argument('--outputs', type=str, default="/`your project path`/outputs/pretrain", help="outputs save directory")
    ...
    parser.add_argument('--bias', type=bool, default=True, help='Disable all biases in Generator')
    ...
    parser.add_argument('--sinc_conv', type=bool, default=False)
