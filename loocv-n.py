...
if __name__ == "__main__":
    ...
    parser.add_argument('--outputs', type=str, default="/`your project path`/outputs/loocv-n", help="outputs save directory")
    ...
    outputs_tmp = args.outputs
    for i in range(1, args.n+1):
        args.outputs = outputs_tmp + '-' + str(i)
